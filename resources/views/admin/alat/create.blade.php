            ...
            <form action="{{ route('admin.alat.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-2">
                    <div class="col-xl-6 mb-2">
                        ...
                        <input type="text" name="nama_alat" class="form-control @error('nama_alat') is-invalid @enderror" value="{{ old('nama_alat') }}">
                        @error('nama_alat')
                    ...
                    <div class="col-xl-6 mb-2">
                        ...
                        <input type="text" name="no_inventaris" class="form-control @error('no_inventaris') is-invalid @enderror" value="{{ old('no_inventaris') }}">
                        @error('no_inventaris')
                            <small class="text-danger">
                                {{ $message }}
                            </small>
                    ...
                    <div class="col-xl-6 mb-2">
                        ...
                        <input type="number" name="jumlah_alat" class="form-control @error('jumlah_alat') is-invalid @enderror" value="{{ old('jumlah_alat') }}">
                        @error('jumlah_alat')
                            <small class="text-danger">
                                {{ $message }}
                            </small>
                    ...
                    <div class="col-xl-6 mb-2">
                        ...
                        <input type="number" name="tahun_perolehan" class="form-control @error('tahun_perolehan') is-invalid @enderror" value="{{ old('tahun_perolehan') }}" min="1900" max="2099" step="1">
                    ...
                    <div class="col-xl-6 mb-2">
                        ...
                        <input type="text" name="penguasaan" class="form-control @error('penguasaan') is-invalid @enderror" value="{{ old('penguasaan') }}">
                        @error('penguasaan')
                            <small class="text-danger">
                                {{ $message }}
                            </small>
