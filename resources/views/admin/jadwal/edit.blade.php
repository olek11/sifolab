                ...
                <div class="row mb-2">
                    <div class="col-xl-6 mb-2">
                        ...
                        <input type="text" name="jenis_kegiatan" class="form-control @error('jenis_kegiatan') is-invalid @enderror"
                               value="{{ old('jenis_kegiatan', $jadwal->jenis_kegiatan) }}" required>
                    ...
                    <div class="col-xl-6 mb-2">
                        ...
                        <input type="date" name="hari_tanggal_mulai" class="form-control @error('hari_tanggal_mulai') is-invalid @enderror"
                               value="{{ old('hari_tanggal_mulai', \Carbon\Carbon::parse($jadwal->hari_tanggal_mulai)->format('Y-m-d')) }}" required onchange="updateDay(this)">
                        @error('hari_tanggal_mulai')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                        <small id="dayStart" class="text-muted"></small>
                    </div>
                    <div class="col-xl-6 mb-2">
                        <label class="form-label">
                        ...
                        <input type="date" name="hari_tanggal_selesai" class="form-control @error('hari_tanggal_selesai') is-invalid @enderror"
                               value="{{ old('hari_tanggal_selesai', \Carbon\Carbon::parse($jadwal->hari_tanggal_selesai)->format('Y-m-d')) }}" required onchange="updateDay(this)">
                        @error('hari_tanggal_selesai')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small id="dayEnd" class="text-muted"></small>
                    </div>
                    <div class="col-xl-6 mb-2">
                        <label class="form-label">
                            <span class="text-danger">*</span> Jam Mulai (WIB) :
                        </label>
                    ...
                    <div class="col-xl-6 mb-2">
                        <label class="form-label">
                            <span class="text-danger">*</span> Jam Selesai (WIB) :
                        </label>
                    ...
                    <div class="col-xl-6 mb-2">
                        ...
                        <input type="text" name="asisten_penanggung_jawab" class="form-control @error('asisten_penanggung_jawab') is-invalid @enderror"
                               value="{{ old('asisten_penanggung_jawab', $jadwal->asisten_penanggung_jawab) }}">
